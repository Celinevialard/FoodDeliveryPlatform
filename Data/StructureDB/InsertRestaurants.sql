...
VALUES(4011,'Chez Tao',  N'Spécialiste de la cuisine chinoise traditionnelle');
...
INSERT INTO Restaurant(locationid, restaurantname, restaurantdescription )
VALUES(4082 ,'Pizzeria Salentina',N'Menus composés de pizza et pâtes élaborés avec le savoir-faire d''une véritable cuisine italienne');

INSERT INTO Restaurant(locationid, restaurantname, restaurantdescription )
VALUES(4082 ,'Momiji',N'Cuisine d''influence japonaise, fraîche, légère, moderne et accessible');

INSERT INTO Restaurant(locationid, restaurantname, restaurantdescription )
VALUES(4111 ,'Grotto de la Fontaine',N'Au Grotto, tout est fait maison à partir de produits bruts, frais, locaux de préférence et selon le marché');
